...
{
    [TestFixture]
    class ByteTypeTests: CodeFixVerifier
    {
        [Test]
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        {
            var result = RunTest( Byte.Range( byte.MinValue, byte.MaxValue, out var value ), 
                                  () => Class1.Same( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( byte.MinValue + 1, byte.MaxValue, out var value ), 
                                  () => Class1.Same( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( byte.MinValue, byte.MaxValue - 1, out var value ), 
                                  () => Class1.Same( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( 100, byte.MaxValue, out var value ), 
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( SmartTest.Byte.Range( 100, byte.MaxValue, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( SmartTests.SmartTest.Byte.Range( 100, byte.MaxValue, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        {
            var result = RunTest( Byte.Range( byte.MinValue, 50, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( 0, 50 ).Range( 100, byte.MaxValue, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( 0, 50 ).Range( 51, 98 ).Range( 100, byte.MaxValue, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( 100, byte.MaxValue ).GetValidValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        {
            byte one = 1;
            var result = RunTest( Byte.Range( one, byte.MaxValue, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        {
            byte one = 1;
            var result = RunTest( Byte.Range( 0, one, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        {
            byte one = 1;
            var result = RunTest( Byte.Range( 0, 100 ).Range( one, byte.MaxValue, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        {
            byte one = 1;
            var result = RunTest( Byte.Range( 0, 100 ).Range( 1, one, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( 50, 100, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( 10, 50 ).Range( 80, 100, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Above( 100, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Above( 100 ).GetValidValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.AboveOrEqual( 100, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.AboveOrEqual( 100 ).GetValidValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Below( 100, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Below( 100 ).GetValidValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.BelowOrEqual( 100, out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.BelowOrEqual( 100 ).GetValidValue( out var value ), 
                                  () => Class1.Inverse( value ) );
