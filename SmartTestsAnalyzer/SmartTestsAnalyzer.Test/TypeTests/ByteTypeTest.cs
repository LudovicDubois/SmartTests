...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Range( 100, byte.MaxValue ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Above( 100 ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.AboveOrEqual( 100 ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.Below( 100 ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( Byte.BelowOrEqual( 100 ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
