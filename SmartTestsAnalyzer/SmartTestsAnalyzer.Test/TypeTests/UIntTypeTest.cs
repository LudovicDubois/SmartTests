...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( UInt.Range( 100, uint.MaxValue ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( UInt.Above( 100 ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( UInt.AboveOrEqual( 100 ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( UInt.Below( 100 ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
...
namespace TestingProject
{
    ...
    public class MyTestClass
    {
        ...
        public void TestMethod()
        {
            var result = RunTest( UInt.BelowOrEqual( 100 ).GetValue( out var value ), 
                                  () => Class1.Inverse( value ) );
