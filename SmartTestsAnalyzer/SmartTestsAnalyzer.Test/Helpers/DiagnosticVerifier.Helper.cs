...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static readonly MetadataReference _SystemRuntimeReference = MetadataReference.CreateFromFile( Path.Combine( Path.GetDirectoryName( typeof(object).Assembly.Location ), "System.Runtime.dll" ) );
        // ReSharper disable once AssignNullToNotNullAttribute
        private static readonly MetadataReference _SystemLinqExpressionsReference = MetadataReference.CreateFromFile( Path.Combine( Path.GetDirectoryName( typeof(object).Assembly.Location ), "System.Linq.Expressions.dll" ) );
        ...
        private static readonly MetadataReference _SmartTestReference = MetadataReference.CreateFromFile( typeof(SmartTest).Assembly.Location );
